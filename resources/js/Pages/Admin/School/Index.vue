<template>
  <DashboardLayout title="Dashboard">
    <template #header>
      <h2 class="font-semibold text-xl text-gray-800 leading-tight">School</h2>
    </template>
              ...
              <table class="w-full">
                ...
                <tbody class="bg-white">
                  <tr
                    ...
                    class="text-gray-700"
                  >
                    <td class="px-4 py-3 border">{{ school.name }}</td>
                    ...
                    <td class="px-4 py-3 text-sm border">
                      <div class="flex justify-around">
                        <Link
                          :href="route('admin.school.edit', school.id)"
                          class="
                            bg-green-500
                            hover:bg-green-700
                            text-white
                        ...
                        <Link
                          :href="route('admin.school.destroy', school.id)"
                          method="delete"
                          as="button"
                          type="button"
                          class="
