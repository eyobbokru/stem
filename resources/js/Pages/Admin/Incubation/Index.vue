                  ...
                  >
                    ...
                    <td class="px-4 py-3 text-sm border">
                      <div class="flex justify-around">
                        <Link
                          :href="route('admin.incubation.show', incubation.id)"
                          class="bg-green-500 hover:bg-green-700 text-white px-4 py-2 rounded-lg"
                        >
                          Show
                        </Link>
                        <Link
                          :href="route('admin.incubation.edit', incubation.id)"
                          class="bg-green-500 hover:bg-green-700 text-white px-4 py-2 rounded-lg"
                        >
                          Edit
                        </Link>
                        <Link
                          :href="
                            route('admin.incubation.destroy', incubation.id)
                          "
                          method="delete"
                          as="button"
                          type="button"
