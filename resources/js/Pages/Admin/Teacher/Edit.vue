<template>
  <DashboardLayout title="edit teacher">
    <template #header>
          ...
          >
            <form @submit.prevent="storeParam">
              <div>
                ...
                <div class="md:flex md:items-center mb-6">
                  <div class="inline-block w-1/3">
                    <jet-label for="fname" value="Father's Name" />
                  </div>
                  <jet-input
                    id="fname"
                    type="text"
                ...
                <div class="md:flex md:items-center mb-6">
                  <div class="inline-block w-1/3">
                    <jet-label for="ty" value="Academic Rank" />
                  </div>
                  <select
                    id="ty"
                    type="text"
                  ...
                  >
                    <option>ARA</option>
                    <option>SARA</option>
                    <option>CARA I</option>
                    <option>CARA I</option>
                    <option>Lecturer</option>
                    <option>Asso. Professor</option>
                    <option>Assis. Professor</option>
                    <option>Professor</option>
                  </select>
                  <div class="text-sm text-red-400" v-if="form.errors.rank">
                    {{ form.errors.rank }}
                  </div>
                </div>
                <div class="md:flex md:items-center mb-6">
                ...
                <div class="md:flex md:items-center mb-6">
                  <div class="inline-block w-1/3">
                    <jet-label for="dept" value="Department" />
                  </div>
                  <jet-input
                    id="dept"
                    type="text"
...
const form = useForm({
  ...
  fname: props.teacher.fname,
  phone: props.teacher.phone,
  email: props.teacher.email,
  department: props.teacher.department,
  type: props.teacher.type,
  rank: props.teacher.rank,
});

function storeParam() {
  form.put("/admin/teacher/" + props.teacher.id);
}
</script>
