<template>
  <DashboardLayout title="create academicSession">
    <template #header>
            ...
            <form @submit.prevent="storeParam">
              <div>
                ...
                <Dropdown
                  ...
                  :value="TypeChoice.name"
                />
                <div class="text-sm text-red-400" v-if="form.errors.type">
                  {{ form.errors.endingDate }}
                </div>
                <jet-label for="group" value="No Groups" />
                <jet-input
                  id="group"
                  type="number"
                  class="mt-1 block w-full"
                  ...
                  :min="1"
                />
                <div class="text-sm text-red-400" v-if="form.errors.year">
                  {{ form.errors.year }}
                </div>
...
//TODO figure out show update value
...
function storeParam() {
  form.post("/admin/academicSession");
}
</script>
