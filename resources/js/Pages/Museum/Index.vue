<template>
  <DashboardLayout title="Dashboard">
    <template #header>
      <h2 class="font-semibold text-xl text-gray-800 leading-tight">Museum</h2>
    </template>
        ...
        <section class="container mx-auto p-6 font-mono">
          ...
          >
            ...
            <div class="w-full overflow-x-auto">
                  ...
                  >
                    ...
                    <td class="px-4 py-3 text-sm border">
                      ...
                      >
                        ...
                        <Link
                          :href="route('stem.museum.edit', museum.id)"
                          class="
                            bg-green-500
                            hover:bg-green-700
                            text-white
                        ...
                        <Link
                          :href="route('stem.museum.destroy', museum.id)"
                          method="delete"
                          as="button"
                          type="button"
                          class="
              ...
              <div class="m-2 p-2">
                <Pagination :links="museums.links" />
              </div>
            </div>
          </div>
        </section>
