            ...
            >
              ...
              >
                ...
                >
                  ...
                  <li class="nav-item ml-5 lg:ml-11">
                    <a class="page-scroll" href="#about">AASTU Museum</a>
                  </li>
                  <li class="nav-item ml-5 lg:ml-11">
        ...
        <div class="row">
          <div class="w-full lg:w-1/2">
            <div class="header_hero_content pt-150 lg:pt-0">
              ...
              >
                AASTU Science
                <span class="text-theme-color">Museum</span>
              </h2>
              <p class="mt-8 lg:mr-8">
                A “Science Museum” is a hands-on platform of scientific
                discovery in an informal setting. A visit to a STEM Synergy
                Science Museum is fun and captivating for students and their
      ...
      <div class="row justify-center">
        <div class="w-ull lg:w-1/2">
          <div class="section_title text-center pb-6">
            <h5 class="sub_title">Museum Items</h5>
            <h4 class="main_title">Some of Our Items</h4>
          </div>
          <!-- section title -->
        </div>
      </div>
